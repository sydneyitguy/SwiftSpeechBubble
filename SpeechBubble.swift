...
class SpeechBubble: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // For non-curvy edges
        // path.addLineToPoint(CGPoint(bubble.minX + bubble.width / 2, bubble.maxY + radius2 + triangleHeight))
        // path.addLineToPoint(CGPoint(bubble.minX + bubble.width / 2 - triangleHeight, bubble.maxY + radius2))
